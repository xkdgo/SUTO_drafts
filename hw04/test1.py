...
class TestSuite(unittest.TestCase):
    def setUp(self):
        ...
        if self.settings.is_server_connect():
            self.settings.cache_set("i:0", '["a", "v"]', 100)
            self.settings.cache_set("i:1", '["a", "v"]', 100)
            self.settings.cache_set("i:2", '["a", "v"]', 100)
            self.settings.cache_set("i:3", '["a", "v"]', 100)

        else:
            pass

    def tearDown(self):
        self.settings.close_conn()
